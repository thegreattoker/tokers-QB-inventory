    ...
    methods: {
        getInitialState() {
            return {
                ...
                // Player Inventory
                playerInventory: {},
                inventoryLabel: "tokers-Inventory",
                totalWeight: 0,
                // Other inventory
                otherInventory: {},
                otherInventoryName: "",
        ...
        openInventory(data) {
            ...
            if (data.player) {
                this.playerCash = data.player.cash || 0;
                this.playerBank = data.player.bank || 0;
                this.playerHealth = data.player.health || 100;
                this.playerArmor = data.player.armor || 0;
                this.playerHunger = data.player.hunger || 100;
                this.playerThirst = data.player.thirst || 100;
                this.playerName = data.player.name || "";
                this.playerJob = data.player.job || "";
            }
        },
