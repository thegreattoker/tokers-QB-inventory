...
function OpenInventoryById(source, targetId)
    ...
    local playerData = {
        ...
        health = (GetEntityHealth(GetPlayerPed(source)) / 200) * 100,
        armor = GetPedArmour(GetPlayerPed(source)),
        hunger = QBPlayer.PlayerData.metadata.hunger or 100,
        thirst = QBPlayer.PlayerData.metadata.thirst or 100,
        name = QBPlayer.PlayerData.charinfo.firstname .. ' ' .. QBPlayer.PlayerData.charinfo.lastname,
        job = QBPlayer.PlayerData.job.label
    }
    TriggerClientEvent('qb-inventory:client:openInventory', source, playerItems, formattedInventory, playerData)
end
...
function OpenShop(source, name)
    ...
    TriggerClientEvent('qb-inventory:client:openInventory', source, Player.PlayerData.items, formattedInventory, playerData)
end
...
function OpenInventory(source, identifier, data)
    ...
    if not identifier then
        ...
        TriggerClientEvent('qb-inventory:client:openInventory', source, QBPlayer.PlayerData.items, nil, playerData)
        return
    end
    ...
    TriggerClientEvent('qb-inventory:client:openInventory', source, QBPlayer.PlayerData.items, formattedInventory, playerData)
end
